 ...
 *  com.kdyzm.spring.helloworld.aopDirk.TestInterface
 */

import com.kdyzm.spring.helloworld.aopDirk.TestInterface;
...
DecoratingProxy {
    ...
    static {
        try {
            ...
            m21 = Class.forName("org.springframework.aop.framework.Advised").getMethod("addAdvisor", Class.forName("org.springframework.aop.Advisor"));
            m13 = Class.forName("org.springframework.aop.framework.Advised").getMethod("isProxyTargetClass", new Class[0]);
            ...
            m8 = Class.forName("org.springframework.aop.framework.Advised").getMethod("setTargetSource", Class.forName("org.springframework.aop.TargetSource"));
            m3 = Class.forName("com.kdyzm.spring.helloworld.aopDirk.TestInterface").getMethod("test", new Class[0]);
            m2 = Class.forName("java.lang.Object").getMethod("toString", new Class[0]);
            m26 = Class.forName("org.springframework.aop.framework.Advised").getMethod("getTargetClass", new Class[0]);
            m22 = Class.forName("org.springframework.aop.framework.Advised").getMethod("addAdvisor", Integer.TYPE, Class.forName("org.springframework.aop.Advisor"));
            ...
            m7 = Class.forName("org.springframework.aop.framework.Advised").getMethod("getAdvisors", new Class[0]);
            m20 = Class.forName("org.springframework.aop.framework.Advised").getMethod("isPreFiltered", new Class[0]);
//            return;
        }
    ...
    public final Advisor[] getAdvisors() {
        try {
            return (Advisor[])this.h.invoke(this, m7, null);
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    public final void setTargetSource(TargetSource targetSource) {
        try {
            this.h.invoke(this, m8, new Object[]{targetSource});
            return;
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
    ...
    public final boolean isProxyTargetClass() {
        try {
            return (Boolean)this.h.invoke(this, m13, null);
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    public final boolean isInterfaceProxied(Class class_) {
        try {
            return (Boolean)this.h.invoke(this, m15, new Object[]{class_});
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    public final boolean removeAdvice(Advice advice) {
        try {
            return (Boolean)this.h.invoke(this, m19, new Object[]{advice});
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    public final boolean isPreFiltered() {
        try {
            return (Boolean)this.h.invoke(this, m20, null);
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    public final void addAdvisor(int n, Advisor advisor) throws AopConfigException {
        try {
            this.h.invoke(this, m22, new Object[]{n, advisor});
            return;
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
    ...
    public final void addAdvisor(Advisor advisor) throws AopConfigException {
        try {
            this.h.invoke(this, m21, new Object[]{advisor});
            return;
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
    ...
    public final boolean replaceAdvisor(Advisor advisor, Advisor advisor2) throws AopConfigException {
        try {
            return (Boolean)this.h.invoke(this, m25, new Object[]{advisor, advisor2});
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
