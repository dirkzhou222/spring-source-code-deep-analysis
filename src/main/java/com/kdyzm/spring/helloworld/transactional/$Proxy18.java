 ...
 *  com.kdyzm.spring.helloworld.transactional.IUserService
 *  com.kdyzm.spring.helloworld.transactional.OrderLine
 */
...
DecoratingProxy {
    ...
    static {
        try {
            ...
            m15 = Class.forName("org.springframework.aop.framework.Advised").getMethod("getProxiedInterfaces", new Class[0]);
            ...
            m7 = Class.forName("org.springframework.aop.framework.Advised").getMethod("getTargetSource", new Class[0]);
            ...
            m19 = Class.forName("org.springframework.aop.framework.Advised").getMethod("addAdvice", Class.forName("org.aopalliance.aop.Advice"));
            ...
            m25 = Class.forName("org.springframework.aop.framework.Advised").getMethod("removeAdvice", Class.forName("org.aopalliance.aop.Advice"));
            m10 = Class.forName("org.springframework.aop.framework.Advised").getMethod("setExposeProxy", Boolean.TYPE);
            ...
            m21 = Class.forName("org.springframework.aop.framework.Advised").getMethod("addAdvisor", Integer.TYPE, Class.forName("org.springframework.aop.Advisor"));
            ...
            m9 = Class.forName("org.springframework.aop.framework.Advised").getMethod("setPreFiltered", Boolean.TYPE);
            m13 = Class.forName("org.springframework.aop.framework.Advised").getMethod("toProxyConfigString", new Class[0]);
            m3 = Class.forName("com.kdyzm.spring.helloworld.transactional.IUserService").getMethod("insertOrderLine", Class.forName("com.kdyzm.spring.helloworld.transactional.OrderLine"));
...
//            return;
    ...
    public final void insertOrderLine(OrderLine orderLine) {
        try {
            this.h.invoke(this, m3, new Object[]{orderLine});
            return;
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
    ...
    public final TargetSource getTargetSource() {
        try {
            return (TargetSource)this.h.invoke(this, m7, null);
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    public final void setPreFiltered(boolean bl) {
        try {
            this.h.invoke(this, m9, new Object[]{bl});
            return;
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
    ...
    public final void setExposeProxy(boolean bl) {
        try {
            this.h.invoke(this, m10, new Object[]{bl});
            return;
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
    ...
    public final String toProxyConfigString() {
        try {
            return (String)this.h.invoke(this, m13, null);
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    public final void addAdvice(int n, Advice advice) throws AopConfigException {
        try {
            this.h.invoke(this, m18, new Object[]{n, advice});
            return;
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
    ...
    public final void addAdvice(Advice advice) throws AopConfigException {
        try {
            this.h.invoke(this, m19, new Object[]{advice});
            return;
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
    ...
    public final void addAdvisor(int n, Advisor advisor) throws AopConfigException {
        try {
            this.h.invoke(this, m21, new Object[]{n, advisor});
            return;
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
    ...
    public final boolean removeAdvisor(Advisor advisor) {
        try {
            return (Boolean)this.h.invoke(this, m23, new Object[]{advisor});
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    public final void removeAdvisor(int n) throws AopConfigException {
        try {
            this.h.invoke(this, m22, new Object[]{n});
            return;
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
    ...
    public final boolean removeAdvice(Advice advice) {
        try {
            return (Boolean)this.h.invoke(this, m25, new Object[]{advice});
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
